<?php namespace App\Http\Controllers;
	...
	class AdminTbProdukStokController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Kode Produk','name'=>'id_produk','type'=>'hidden'];
			...
			//$this->form[] = ["label"=>"Stok In","name"=>"stok_in","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Stok Out","name"=>"stok_out","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
	    ...
	    */
	    public function hook_after_add($id) {
	        //Your code here
			$stok = CRUDBooster::first('tb_produk_stok',$id);
			$produk = CRUDBooster::first('tb_produk',$stok->id_produk);
	    	$update_stok = $produk->stok + $stok->stok_masuk - $stok->stok_keluar;
			
			DB::table('tb_produk')->where('id', $produk->id)->update(['stok'=>$update_stok]);
	    }
