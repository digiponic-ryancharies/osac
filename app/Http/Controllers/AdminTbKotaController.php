<?php namespace App\Http\Controllers;
	...
	class AdminTbKotaController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$kode = DB::table('tb_kota')->max('id') + 1;
			$kode = 'SUBAREA1/'.str_pad($kode,3,0,STR_PAD_LEFT);

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Kode Provinsi','name'=>'kode_provinsi','type'=>'hidden'];
	        ...
	        */
			...
			$this->sub_module[] = ['label'=>'','path'=>'tb_kecamatan','parent_columns'=>'kode,keterangan','foreign_key'=>'id_kota','button_color'=>'info','button_icon'=>'fa fa-flag-checkered'];
