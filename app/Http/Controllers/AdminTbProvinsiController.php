<?php namespace App\Http\Controllers;
	...
	class AdminTbProvinsiController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$kode = DB::table('tb_provinsi')->max('id') + 1;
			$kode = 'AREA/'.str_pad($kode,3,0,STR_PAD_LEFT);
	        ...
	        */
			...
			$this->sub_module[] = ['label'=>'','path'=>'tb_kota','parent_columns'=>'kode,keterangan','foreign_key'=>'id_provinsi','button_color'=>'info','button_icon'=>'fa fa-flag-o'];
