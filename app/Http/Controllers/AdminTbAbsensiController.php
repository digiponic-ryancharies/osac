<?php namespace App\Http\Controllers;
	...
	class AdminTbAbsensiController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			// $this->form[] = ['label'=>'Kode Karyawan','name'=>'kode_karyawan','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Tanggal','name'=>'tanggal','type'=>'date','validation'=>'required|date','width'=>'col-sm-10','value'=>$date];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Kode Karyawan","name"=>"kode_karyawan","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Tanggal","name"=>"tanggal","type"=>"date","required"=>TRUE,"validation"=>"required|date"];
			//$this->form[] = ["label"=>"Jam Masuk","name"=>"jam_masuk","type"=>"time","required"=>TRUE,"validation"=>"required|date_format:H:i:s"];
