<?php namespace App\Http\Controllers;
	...
	class AdminTbPelangganKendaraanController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "tb_pelanggan_kendaraan";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Merek Kendaraan","name"=>"id_merek_kendaraan","join"=>"tb_merek_kendaraan,keterangan"];
			$this->col[] = ["label"=>"Kendaraan","name"=>"id_kendaraan","join"=>"tb_kendaraan,keterangan"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Pelanggan','name'=>'id_pelanggan','type'=>'hidden','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Merek Kendaraan','name'=>'id_merek_kendaraan','type'=>'select','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'tb_merek_kendaraan,keterangan'];
			$this->form[] = ['label'=>'Kendaraan','name'=>'id_kendaraan','type'=>'select','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'tb_kendaraan,keterangan','parent_select'=>'id_merek_kendaraan'];
			$this->form[] = ['label'=>'Nomor Polisi','name'=>'nomor_polisi','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Nomor Rangka','name'=>'nomor_rangka','type'=>'number','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Tahun','name'=>'tahun','type'=>'number','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Warna','name'=>'warna','type'=>'text','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Nomor Rangka","name"=>"nomor_rangka","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Tahun","name"=>"tahun","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Warna","name"=>"warna","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
	    ...
	    */
	    public function hook_after_delete($id) {
	        //Your code here
			DB::table('tb_pelanggan_kendaraan')->where('id',$id)->update([
