<?php namespace App\Http\Controllers;
	...
	class AdminTbGeneralController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$kode = DB::table('tb_general')->max('id') + 1;
			$kode = 'GN/'.str_pad($kode, 5, 0, STR_PAD_LEFT);
			...
			$this->form[] = ['label'=>'Tipe','name'=>'id_tipe','type'=>'hidden',];
			$this->form[] = ['label'=>'Gambar','name'=>'gambar','type'=>'upload','validation'=>'image|max:500','width'=>'col-sm-10','upload_encrypt'=>true];
			...
			//$this->form[] = ["label"=>"Kode Tipe","name"=>"kode_tipe","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
	        ...
	        */
			...
			// $this->sub_module[] = ['label'=>'Invetaris','path'=>'tb_general_detail','parent_columns'=>'kode,keterangan','foreign_key'=>'kode_general','button_color'=>'info','showIf'=>'[kode_tipe] == 2'];
			// $this->sub_module[] = ['label'=>'','path'=>'tb_kendaraan','parent_columns'=>'kode,keterangan','foreign_key'=>'kode_general','button_color'=>'info','button_icon'=>'fa fa-edit'];
	    ...
	    */
	    public function hook_after_delete($id) {
	        //Your code here
			DB::table('tb_tipe')->where('id',$id)->update([
