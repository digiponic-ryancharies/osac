<?php namespace App\Http\Controllers;
	...
	class AdminTbTipeController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$kode = DB::table('tb_tipe')->max('id') + 1;
			$kode = 'TP/'.str_pad($kode, 3, 0, STR_PAD_LEFT);
	        ...
	        */
			...
			$this->sub_module[] = ['label'=>'','path'=>'tb_general','parent_columns'=>'kode,keterangan','foreign_key'=>'id_tipe','button_color'=>'warning','button_icon'=>'fa fa-edit'];
