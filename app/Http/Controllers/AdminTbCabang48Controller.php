<?php namespace App\Http\Controllers;
	...
	class AdminTbCabang48Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Kode Cabang","name"=>"kode_cabang","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Nama Cabang","name"=>"nama_cabang","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Alamat","name"=>"alamat","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Telfon","name"=>"telfon","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Logo","name"=>"logo","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Email","name"=>"email","type"=>"email","required"=>TRUE,"validation"=>"required|min:1|max:255|email|unique:tb_cabang","placeholder"=>"Mohon input alamat email dengan benar"];
			//$this->form[] = ["label"=>"Pin","name"=>"pin","type"=>"password","required"=>TRUE,"validation"=>"min:3|max:32","help"=>"Minimal 5 karakter. Tinggalkan jika anda tidak mengubahnya"];
